    ...
    <Div p={4} mx={1}>
      <Div pt={3} px={2} maxWidth="960px">
        <Section>
          ...
          <Para>
            <Link href="https://jxnblk.com/grid-styled/">Grid Styled</Link> is a
          ...
          <Flex bg="white" flexWrap="wrap" align="center" mb={4}>
            <Box width={[1, 1 / 2, 1 / 3, 1 / 4]}>
              <Div py={4} border="1px solid" borderColor="#EEE">
                Box
              </Div>
            </Box>
            <Box width={[1, 1 / 2, 1 / 3, 1 / 4]}>
        ...
        <Section>
          ...
          {Object.keys(props.theme.space).map((space) => {
            if (parseInt(space) !== 0) {
              return (
                <Div
                  key={'spaceScale' + space}
                  bg="white"
