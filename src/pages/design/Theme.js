              ...
              return (
                <Flex
                  ...
                  css={{
                    position: 'relative',
                    background: 'white',
                    border: 'solid 1px ' + props.theme.colors.gray2,
                  }}
                  p={3}
                  mb={3}
                >
                  <Box
                    width={[255, 255, 255, 255, 20]}
                    key={color}
                    p={3}
                    mr={3}
                    bg={props.theme.colors[color]}
                  />
                  <Box pt={[2, 2, 2, 2, 0]}>
                    {color !== 'base' ? (
                      <Input
                        style={{ fontFamily: props.theme.font }}
                        onBlur={(e) => {
                          if (e.target.value !== '') {
                            props.update(
                              updateColorName({
                    ...
                    <Input
                      data-value={props.theme.colors[color]
                        .toUpperCase()
                        .replace('#', '')}
                      onBlur={(e) => {
                        if (
                          ...
                          e.target.value = props.theme.colors[
                            color
                          ].toUpperCase()
                        }
                      }}
                      width={120}
                      defaultValue={props.theme.colors[color].toUpperCase()}
                    />
                  </Box>
                  {color !== 'base' && (
                    <Div
                    ...
                    >
                      <Span
                        ...
                        right="8px"
                        data-color={color}
                        onClick={(e) => props.update(deleteColor(color))}
                        fontSize="24px"
                        color={props.theme.colors.red6 || 'indianred'}
                        children="×"
                      />
                    </Div>
                  )}
