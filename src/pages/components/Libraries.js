...
export default (props) => (
  <Section>
    <Section>
      <Text pb={2}>
        In addition to your own components, you can use components from other
        Styled System compatible libraries.
      </Text>
      <Text py={2}>
        For example, a Panel component from{' '}
        <Link href="http://jxnblk.com/rebass/">Rebass</Link>:
      </Text>
      <CodeSpecimen
        f="12px"
        width={2 / 3}
        code={`<Panel color='base'>
