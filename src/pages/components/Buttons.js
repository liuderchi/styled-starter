        ...
        <Section>
          ...
          <Div pb={4}>
            <CodeSpecimen
              f="12px"
              w={2 / 3}
              code={`<Button>Base Button</Button>`}
              scope={scope}
            />
          </Div>
          ...
          {Object.keys(props.theme.colors).map((color) => {
            if (
              ...
              return (
                <CodeSpecimen
                  key={'buttonOutlineCodeSpecimen-' + color}
                  f="14px"
                  w={2 / 3}
                  code={
                    `<ButtonOutline color="` +
          ...
          <CodeSpecimen
            f="14px"
            w={2 / 3}
            code={`<Button bg="gray" disabled>Disabled</Button>`}
            scope={scope}
          />
          <CodeSpecimen
            f="14px"
            w={2 / 3}
            code={`<ButtonSmall>Small Button</ButtonSmall>`}
            scope={scope}
          />
          <CodeSpecimen
            f="14px"
            w={2 / 3}
            code={`<ButtonLarge>Large Button</ButtonLarge>`}
            scope={scope}
          />
        </Section>
      </Div>
