...
gold.font = gold.fontFamilies[0]
gold.webfonts = ['Montserrate']
gold.colors = {
  base: '#f3c200',
  black: '#000',
  blue: '#00aaff',
...
indigo.name = 'Indigo'
indigo.fontFamilies = ["'Raleway',sans-serif"]
indigo.font = indigo.fontFamilies[0]
indigo.webfonts = ['Raleway']
indigo.colors = {
  base: '#4b0082',
  black: '#000',
  blue: '#003882',
...
orchid.name = 'Orchid'
orchid.fontFamilies = ["'Quicksand',sans-serif"]
orchid.font = orchid.fontFamilies[0]
orchid.webfonts = ['Quicksand']
orchid.colors = {
  base: '#da70d6',
  black: '#000',
  blue: '#70a1da',
...
peru.name = 'Peru'
peru.fontFamilies = ["'Roboto',sans-serif"]
peru.font = peru.fontFamilies[0]
peru.webfonts = { sans: 'Roboto' }
peru.colors = {
  base: '#CD853F',
  black: '#000',
  blue: '#3f88cd',
...
salmon.name = 'Salmon'
salmon.fontFamilies = ["'Istok Web',sans-serif"]
salmon.font = salmon.fontFamilies[0]
salmon.webfonts = ['Istok+Web']
salmon.colors = {
  base: '#ffa07a',
  black: '#000',
  blue: '#72a8fa',
...
sky.name = 'Sky'
sky.fontFamilies = ["'Open Sans',sans-serif"]
sky.font = sky.fontFamilies[0]
sky.webfonts = ['Open+Sans']
sky.colors = {
  base: '#00bfff',
  black: '#000',
  blue: '#0040ff',
...
turquoise.fontFamilies = ["'PT Sans',sans-serif"]
turquoise.font = turquoise.fontFamilies[0]
turquoise.webfonts = ['PT+Sans']
turquoise.colors = {
  base: '#48D1CC',
  black: '#000',
  blue: '#4893d1',
